...
public class PlayGame extends javax.swing.JFrame {
    ...
    private void pregwin() {
        if(!btnC1.isEnabled() && !btnC2.isEnabled() && !btnC3.isEnabled() && !btnC4.isEnabled() && !btnC5.isEnabled() && !btnC6.isEnabled() && 
            ...
            JOptionPane.showMessageDialog(this, "Felicidades,sacaste 10 en JAVA, Su puntaje es: "+puntaje, "Win!!", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Memorama Brenda");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(102, 102, 102));
        jLabel1.setText("Memorama de Brenda");
